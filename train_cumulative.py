...
if __name__ == "__main__":
    ...
    parser.add_argument('--w_direction', type=float, default=1.0, help='Weight for direction loss')
    parser.add_argument('--w_zero', type=float, default=1.0, help='Weight for zero loss')
