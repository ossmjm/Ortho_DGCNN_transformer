...
class OrthoDGCNNModel(nn.Module):
    ...
    def forward(self, coordinates, targets=None, cumulative_targets=None, activity_targets=None, param_activity_targets=None, num_stages=None, epoch=None, total_epochs=None):
